...
public class HospitalInfoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        BackButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent2 = new Intent(getApplicationContext(), HospitalMapActivity.class);
